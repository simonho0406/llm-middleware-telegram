...
def escape_format_braces(value: object) -> str:
    ...
    LLM responses and user input often contain '{' and '}' (JSON examples, code,
    math notation). Passing them directly to str.format() raises KeyError or
    IndexError because Python treats them as format placeholders.
    """
